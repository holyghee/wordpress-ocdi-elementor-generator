...
function sharebox() {
  ?>
							<div class="hidden share-remove">
                                <div class="share-box">
                                   <span class="share-text"><?php esc_html_e("Share this:", "cholot_plugin"); ?> </span>
                                   ...
                                   <a class="pt-share" href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php 
                                   global $post;
                                   $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); echo $url; ?>" 
                                   title="<?php esc_html_e("Pin This", "cholot_plugin"); ?>">
