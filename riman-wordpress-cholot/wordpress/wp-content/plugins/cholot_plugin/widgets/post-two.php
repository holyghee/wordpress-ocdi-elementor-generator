 ...
 * @since 1.1.0
 */
class Cholot_PostTwo extends Widget_Base {
	...
	public function get_name() {
		return 'cholot-post-two';
	}

	//script depend
	public function get_script_depends() { return [ 'jquery-isotope','cholot-blog-masonry' ]; }
	...
	public function get_title() {
		return __( 'Cholot Post List Style 2', 'cholot_plugin' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'blog_icon',
			[
				'label' => __( 'Show Blog Icon', 'cholot_plugin' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_on' => __( 'Yes', 'cholot_plugin' ),
				'label_off' => __( 'No', 'cholot_plugin' ),
		...
		$this->add_control(
			'no_margin',
			[
				'label' => __( 'No Spacing.', 'cholot_plugin' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'label_on' => __( 'Yes', 'cholot_plugin' ),
				'label_off' => __( 'No', 'cholot_plugin' ),
		...
		$this->add_responsive_control(
			'margin_size',
			[
				'label' => __( 'Custom Spacing Size', 'cholot_plugin' ),
		...
		$this->add_control(
			'excerpt-align',
			[
				'label' => __( 'Excerpt & Button Alignment', 'cholot_plugin' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'cholot_plugin' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .blog-post-list .cholot-blog-box h3' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .blog-post-list:hover .cholot-blog-box h3' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'text_section',
			[
				'label' => __( 'Excerpt Settings', 'cholot_plugin' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'icon_setting',
			[
				'label' => __( 'Blog Icon','cholot_plugin' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'blog_icon' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Page Container Margin', 'cholot_plugin' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
                        	...
                        	<div class="blog-col-inner">
                                ...
                                <a class="blog-link-img blog-with-box" href="<?php the_permalink(); ?>"> 
                                    ...
                                    <?php if  ($settings['blog_icon'] == 'yes') { 
										global $post; if ( get_post_meta( get_the_ID(), 'post_format', true) == 'post_slider'){ ?>
