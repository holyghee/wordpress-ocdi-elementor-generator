 ...
 * @since 1.1.0
 */
class Cholot_Testimonial_Two extends Widget_Base
{
	...
	{
		return __('Cholot Testimonial style Two', 'cholot_plugin');
	}
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'raw' => __('<b>Note:</b> You can see the better preview of testimonial (responsiveness) in the actual page.', 'cholot_plugin'),
		...
		$this->add_control(
			'show_desktop',
			[
				'label' => __('Testimonial Show in Desktop', 'cholot_plugin'),
		...
		$this->add_control(
			'show_tablet',
			[
				'label' => __('Testimonial Show in Tablet', 'cholot_plugin'),
				'type' => Controls_Manager::NUMBER,
				'default' => 2,
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'show_mobile',
			[
				'label' => __('Testimonial Show in Mobile', 'cholot_plugin'),
				'type' => Controls_Manager::NUMBER,
				'default' => 1,
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'slider_speed',
			[
				'label' => __('Testimonial Slide Speed', 'cholot_plugin'),
				'type' => Controls_Manager::NUMBER,
				'default' => 5000,
				'frontend_available' => true,
			]
		...
		$this->add_responsive_control(
			'content-align',
			[
				'label' => __('Content Alignment', 'cholot_plugin'),
				...
				'selectors' => [
					'{{WRAPPER}} .testi-inner' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testimonial .testi-text' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .testi-text::after' => 'border-color: {{VALUE}} transparent transparent transparent;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .testimonial .testi-text' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .testimonial .testi-text' => 'margin:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} .testimonial .testi-text' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'testi_box_setting',
			[
				'label' => __('Testimonial Box Setting', 'cholot_plugin'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .testi-inner' => 'margin:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .testi-inner' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name' => 'testi_box_border',
				'placeholder' => '1px',
				'default' => '',
				'selector' => '{{WRAPPER}} .testi-inner',
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} .testi-inner' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testi-inner' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .testi-inner .testi-icon' => 'margin:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .testi-inner .testi-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .testi-inner .testi-icon' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'icon_lheight',
			[
				'label' => __('Icon Line height', 'cholot_plugin'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
				...
				'selectors' => [
					'{{WRAPPER}} .testi-inner .testi-icon' => 'line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name' => 'testi_icon_border',
				'placeholder' => '1px',
				'default' => '',
				'selector' => '{{WRAPPER}} .testi-inner .testi-icon',
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'icon_radius',
			[
				'label' => __('Icon border radius', 'cholot_plugin'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .testi-inner .testi-icon' => 'border-radius: margin:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testi-inner .testi-icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .testi-inner .testi-icon' => 'background-color: {{VALUE}};',
				],
			]
		);
...
<div class="testimonial testi-two" data-slide="<?php echo esc_attr($settings['show_desktop']) ?>"
    data-slide-tablet="<?php echo esc_attr($settings['show_tablet']) ?>"
...
<?php
	...
	wp_enqueue_script('cholot-testimonial', plugins_url('/js/testimonial-two.js', __FILE__), array('jquery'), null, true);
}
